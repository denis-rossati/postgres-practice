...
describe('The Actors controller', () => {
    describe('getAll', () => {
        ...
        let resProps: { [key: string]: jest.Mock };
    ...
    describe('getById', () => {
        ...
        it(
            'should return code 204 if the response returns a object whose number of keys are greater than 3',
            async () => {
                const mockData = {
                    actor: {
                        one: '', two: '', three: '', four: '',
        ...
        it(
            'should return code 204 if the response returns a object whose number of keys are lesser than 3',
            async () => {
                const mockData = {
                    actor: {
                        one: '', two: '',
